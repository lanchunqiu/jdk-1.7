...
public abstract class SignatureAlgorithmSpi {
   ...
   /**
    * Proxy method for {@link java.security.Signature#initSign(java.security.PrivateKey, SecureRandom)}
    * which is executed on the internal {@link java.security.Signature} object.
    *
    * @param signingKey
    * @param secureRandom
   ...
   /**
    * Proxy method for {@link java.security.Signature#setParameter(AlgorithmParameterSpec)}
    * which is executed on the internal {@link java.security.Signature} object.
    *
    * @param params
    * @throws XMLSignatureException
